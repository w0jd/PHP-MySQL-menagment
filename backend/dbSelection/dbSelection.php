        ...
        if($dbConnect){
            ...
            if(mysqli_query($dbConnect,$dbUsage)){
                ...
                while ($row = mysqli_fetch_row($Tables)) {
                    echo "<option class='selectionRow' value='$row[0]'>$row[0]</option>";
                    
                }echo "</select><label for='allTables'>Show all tables</label><input name='allTables' id='allTables' type='checkbox'></section><section class='log-in'><input class='submit-button' type='submit' value='select'></section></form>";}else{
...
?>
        ...
        <script src="../../frontend/javascript/selection.js">whatIsSelected();</script>
    </body>
</html>